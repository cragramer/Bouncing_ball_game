...
void EIE3810_TFTLCD_clean(u16 color) { EIE3810_TFTLCD_FillRectangle(0, 480, 0, 800, color); }
...
void EIE3810_TFTLCD_ShowChar(u16 x, u16 y, u8 ASCII, u16 color, u16 bgcolor) {
	...
	EIE3810_TFTLCD_WrData(x & 0xFF);
	EIE3810_TFTLCD_WrCmd(0x2A02);
	EIE3810_TFTLCD_WrData((8 + x - 1) >> 8);
	EIE3810_TFTLCD_WrCmd(0x2A03);
	EIE3810_TFTLCD_WrData((8 + x - 1) & 0xFF);
	...
	EIE3810_TFTLCD_WrData(y & 0xFF);
	EIE3810_TFTLCD_WrCmd(0x2B02);
	EIE3810_TFTLCD_WrData((16 + y - 1) >> 8);
	EIE3810_TFTLCD_WrCmd(0x2B03);
	EIE3810_TFTLCD_WrData((16 + y - 1) & 0xFF);

	EIE3810_TFTLCD_WrCmd(0x2C00);
	if (ASCII > 127 || ASCII < 32) { return; }
	//for (index=0; index < 16*8; index++){
	ASCII -= 32;
	for (w = 0;w < 8;w++) {
		for (i = 0;i < 16;i = i + 2) {
			if ((asc2_1608[ASCII][i] >> (7 - w)) & 1) {
				EIE3810_TFTLCD_WrData(color);
			}
...
void EIE3810_TFTLCD_rect_x(u16 start_x, u16 start_y, u16 color) {
	EIE3810_TFTLCD_FillRectangle(start_x, 55, start_y, 10, color);
}
void EIE3810_TFTLCD_rect_y(u16 start_x, u16 start_y, u16 color) {
	EIE3810_TFTLCD_FillRectangle(start_x, 10, start_y, 55, color);
}
void EIE3810_TFTLCD_rect_0(u16 start_x, u16 start_y, u16 color) {
	EIE3810_TFTLCD_rect_y(start_x, start_y - 65, color);
	EIE3810_TFTLCD_rect_y(start_x, start_y - 130, color);
	EIE3810_TFTLCD_rect_y(start_x + 65, start_y - 130, color);
	EIE3810_TFTLCD_rect_y(start_x + 65, start_y - 65, color);
	EIE3810_TFTLCD_rect_x(start_x + 10, start_y - 10, color);
	//EIE3810_TFTLCD_rect_x(start_x+10,start_y-75,color);
	EIE3810_TFTLCD_rect_x(start_x + 10, start_y - 140, color);
}
void EIE3810_TFTLCD_rect_1(u16 start_x, u16 start_y, u16 color) {
	//EIE3810_TFTLCD_rect_y(start_x,start_y-65,color);
	//EIE3810_TFTLCD_rect_y(start_x,start_y-130,color);
	EIE3810_TFTLCD_rect_y(start_x + 65, start_y - 130, color);
	EIE3810_TFTLCD_rect_y(start_x + 65, start_y - 65, color);
...
void EIE3810_TFTLCD_rect_2(u16 start_x, u16 start_y, u16 color) {
	EIE3810_TFTLCD_rect_y(start_x, start_y - 65, color);
	//EIE3810_TFTLCD_rect_y(start_x,start_y-130,color);
	EIE3810_TFTLCD_rect_y(start_x + 65, start_y - 130, color);
	//EIE3810_TFTLCD_rect_y(start_x+65,start_y-65,color);
...
void EIE3810_TFTLCD_rect_3(u16 start_x, u16 start_y, u16 color) {
	//EIE3810_TFTLCD_rect_y(start_x,start_y-65,color);
	//EIE3810_TFTLCD_rect_y(start_x,start_y-130,color);
	EIE3810_TFTLCD_rect_y(start_x + 65, start_y - 130, color);
	EIE3810_TFTLCD_rect_y(start_x + 65, start_y - 65, color);
...
void EIE3810_TFTLCD_rect_4(u16 start_x, u16 start_y, u16 color) {
	//EIE3810_TFTLCD_rect_y(start_x,start_y-65,color);
	EIE3810_TFTLCD_rect_y(start_x, start_y - 130, color);
	EIE3810_TFTLCD_rect_y(start_x + 65, start_y - 130, color);
	EIE3810_TFTLCD_rect_y(start_x + 65, start_y - 65, color);
...
void EIE3810_TFTLCD_rect_5(u16 start_x, u16 start_y, u16 color) {
	//EIE3810_TFTLCD_rect_y(start_x,start_y-65,color);
	EIE3810_TFTLCD_rect_y(start_x, start_y - 130, color);
	//EIE3810_TFTLCD_rect_y(start_x+65,start_y-130,color);
	EIE3810_TFTLCD_rect_y(start_x + 65, start_y - 65, color);
...
void EIE3810_TFTLCD_rect_6(u16 start_x, u16 start_y, u16 color) {
	EIE3810_TFTLCD_rect_y(start_x, start_y - 65, color);
	EIE3810_TFTLCD_rect_y(start_x, start_y - 130, color);
	//EIE3810_TFTLCD_rect_y(start_x+65,start_y-130,color);
	EIE3810_TFTLCD_rect_y(start_x + 65, start_y - 65, color);
...
void EIE3810_TFTLCD_rect_7(u16 start_x, u16 start_y, u16 color) {
	//EIE3810_TFTLCD_rect_y(start_x,start_y-65,color);
	//EIE3810_TFTLCD_rect_y(start_x,start_y-130,color);
	EIE3810_TFTLCD_rect_y(start_x + 65, start_y - 130, color);
	EIE3810_TFTLCD_rect_y(start_x + 65, start_y - 65, color);
...
void EIE3810_TFTLCD_rect_8(u16 start_x, u16 start_y, u16 color) {
	EIE3810_TFTLCD_rect_y(start_x, start_y - 65, color);
	EIE3810_TFTLCD_rect_y(start_x, start_y - 130, color);
	EIE3810_TFTLCD_rect_y(start_x + 65, start_y - 130, color);
	EIE3810_TFTLCD_rect_y(start_x + 65, start_y - 65, color);
...
void EIE3810_TFTLCD_rect_9(u16 start_x, u16 start_y, u16 color) {
	//EIE3810_TFTLCD_rect_y(start_x,start_y-65,color);
	EIE3810_TFTLCD_rect_y(start_x, start_y - 130, color);
	EIE3810_TFTLCD_rect_y(start_x + 65, start_y - 130, color);
	EIE3810_TFTLCD_rect_y(start_x + 65, start_y - 65, color);
...
void  EIE3810_TFTLCD_SevenSegment(u16 start_x, u16 start_y, u8 digit, u16 color) {
	if (digit == 0) { EIE3810_TFTLCD_rect_0(start_x, start_y, color); }
	if (digit == 1) { EIE3810_TFTLCD_rect_1(start_x, start_y, color); }
	if (digit == 2) { EIE3810_TFTLCD_rect_2(start_x, start_y, color); }
	if (digit == 3) { EIE3810_TFTLCD_rect_3(start_x, start_y, color); }
	if (digit == 4) { EIE3810_TFTLCD_rect_4(start_x, start_y, color); }
	if (digit == 5) { EIE3810_TFTLCD_rect_5(start_x, start_y, color); }
	if (digit == 6) { EIE3810_TFTLCD_rect_6(start_x, start_y, color); }
	if (digit == 7) { EIE3810_TFTLCD_rect_7(start_x, start_y, color); }
	if (digit == 8) { EIE3810_TFTLCD_rect_8(start_x, start_y, color); }
	if (digit == 9) { EIE3810_TFTLCD_rect_9(start_x, start_y, color); }
}
